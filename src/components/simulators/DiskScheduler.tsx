          ...
          <Card variant="terminal">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Select value={algorithm} onValueChange={(v) => { setAlgorithm(v as DiskAlgorithm); setResult(null); }}>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  ...
                  <Input
                    type="number"
                    value={headPosition}
                    onChange={(e) => { setHeadPosition(parseInt(e.target.value) || 0); setResult(null); }}
                    min={0}
                    max={maxCylinder}
                    variant="terminal"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    type="number"
                    value={maxCylinder}
                    onChange={(e) => { setMaxCylinder(parseInt(e.target.value) || 199); setResult(null); }}
                    min={100}
                    variant="terminal"
                  />
                </div>
                  ...
                  {result.seekOperations.map((op, index) => (
                    <motion.div
                      ...
                      className={`
                        ...
                        ${index === currentStep ? 'bg-primary/10 border-primary/50' : 'bg-muted/30 border-border'}
                      `}
                    >
